...
void Vehicle::DrawModel(DirectX::SimpleMath::Matrix aWorld, DirectX::SimpleMath::Matrix aView, DirectX::SimpleMath::Matrix aProj)
{
    ...
    m_heliModel.mainRotorAxelShape->Draw(m_heliModel.mainRotorAxelMatrix, view, proj, bodyColor);
    m_heliModel.mainRotorHubShape->Draw(m_heliModel.mainRotorHubMatrix, view, proj, bodyColor);

    m_heliModel.mainRotorBladeShape->Draw(m_heliModel.mainRotorBladeMatrix1, view, proj, bodyColor);
    m_heliModel.mainRotorBladeShape->Draw(m_heliModel.mainRotorBladeMatrix2, view, proj, bodyColor);
...
void Vehicle::InitializeModel(Microsoft::WRL::ComPtr<ID3D11DeviceContext1> aContext)
{
    ...
    const DirectX::SimpleMath::Vector3 tailBoomSize(7.0f, 1.0f, 1.0f);
    ...
    const DirectX::SimpleMath::Vector3 mainAxelTranslation(0.0f, bodySize.y + (mainAxelLength * 0.5f), 0.0f);
    ...
    m_heliModel.mainRotorArmShape = DirectX::GeometricPrimitive::CreateCylinder(aContext.Get(), 12.0f, 0.15f);
    ...
    const DirectX::SimpleMath::Vector3 rotorBladeSize(rotorArmSize.x * 0.47f, rotorArmSize.y, 0.8f);
    ...
    //const DirectX::SimpleMath::Vector3 rotorBladeTranslation2(-mainHubTranslation.x - (rotorBladeSize.x * 0.5f), mainHubTranslation.y, -rotorBladeSize.z * 0.5f);
    const DirectX::SimpleMath::Vector3 rotorBladeTranslation2(((- rotorArmSize.x * 0.5f) + (rotorBladeSize.x * 0.5f)), mainHubTranslation.y, 0.0f);
    ...
    m_heliModel.mainRotorEdgeShape = DirectX::GeometricPrimitive::CreateCylinder(aContext.Get(), rotorBladeSize.x, rotorBladeSize.y);
    ...
    const DirectX::SimpleMath::Vector3 rotorEdgeTranslation1(3.18000007, (mainHubTranslation.y - 0.35f), 0.0f);
    ...
    m_heliModel.mainRotorEdgeMatrix1 *= DirectX::SimpleMath::Matrix::CreateRotationY(Utility::ToRadians(-30.0f));
...
void Vehicle::UpdateModel(const double aTimer)
{
    ...
    //m_rotorTimer = 0.0f;
    DirectX::SimpleMath::Matrix mainRotorSpin = DirectX::SimpleMath::Matrix::CreateRotationY(m_rotorTimer);
    DirectX::SimpleMath::Matrix rotorPitch = DirectX::SimpleMath::Matrix::CreateRotationX(cos(m_rotorTimer));
    ...
    DirectX::SimpleMath::Matrix rotorPitchTest = DirectX::SimpleMath::Matrix::CreateRotationY(cos(m_rotorTimer));
    /*
